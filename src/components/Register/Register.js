...
class Register extends React.Component {
  ...
  // when registering, we will have route change that will also fill in values fo id, email, password, etc.
  onSubmitSignIn = () => {
    ...
    .then(user => {
      if (user) {
        // load user then redirect to home page
        this.propsloadUser(user)
